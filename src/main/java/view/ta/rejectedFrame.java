...
public class rejectedFrame extends JFrame {
    ...
    // ✅ Object Stream 기반 생성자
    public rejectedFrame(Socket socket, ObjectOutputStream out, ObjectInputStream in) {
        this.socket = socket;
        this.out = out;
        this.in = in;

        initComponents(); // GUI 초기화
        controller = new RejectedController(this, socket, out, in); // 👈 Controller도 ObjectStream 버전 필요
